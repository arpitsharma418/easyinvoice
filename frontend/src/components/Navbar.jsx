...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full z-40 px-4 pt-4 sm:px-8">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between rounded-xl border border-black/10 bg-white px-4 sm:px-6">
        ...
        <div className="hidden items-center gap-6 md:flex">
          ...
          {user ? (
            <>
              ...
              <span
                title={user.name}
                className="flex h-8 w-8 items-center justify-center rounded-full bg-sky-600 ring-3 ring-black text-white"
              >
